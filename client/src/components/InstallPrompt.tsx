			...
			<div class="fixed bottom-20 left-4 right-4 z-50 mx-auto max-w-md rounded-lg bg-zinc-800 p-4 shadow-xl">
				<div class="flex items-start gap-3">
					<div class="flex-shrink-0">
						<img src="/icons/icon-192x192.png" alt="FreeSpeech" class="h-12 w-12 rounded-lg" />
					</div>
					<div class="flex-1">
						<h3 class="text-base font-semibold text-white">Install FreeSpeech</h3>
						<p class="mt-1 text-sm text-zinc-400">Add to your home screen for faster access and offline use.</p>
					...
					<button onClick={handleDismiss} class="flex-shrink-0 text-zinc-500 hover:text-white" aria-label="Dismiss">
						<i class="bi bi-x-lg" />
					</button>
				</div>
			</div>
