import { setActiveModalId, projectToOptimize } from '@/lib/state';
          ...
          <div class="flex flex-col gap-4">
                ...
                <div class="text-center py-4">
                  <p class="text-zinc-300">
                    ...
                    <Show when={alreadyOptimized() > 0}>
                      {' '}All {alreadyOptimized()} images are already optimized.
                    </Show>
                  </p>
                </div>
              }
            >
              <div class="rounded-lg bg-zinc-800 p-4">
                <p class="text-zinc-300">
                  You are about to optimize <span class="font-bold text-white">{imageCount()}</span> images
                  in <span class="font-bold text-white">{project()?.name}</span>.
                </p>
                <Show when={alreadyOptimized() > 0}>
            ...
            <Show when={oldTotalSize() > 0}>
              <div class="rounded-lg bg-zinc-800 p-4">
                ...
                <p class="mt-2 text-center text-sm text-zinc-400">
                  Saved {formatBytes(oldTotalSize() - newTotalSize())} ({Math.round((1 - newTotalSize() / oldTotalSize()) * 100)}% reduction)
                </p>
              </div>
            </Show>
