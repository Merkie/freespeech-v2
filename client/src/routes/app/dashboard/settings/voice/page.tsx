    ...
    <div class="flex flex-col gap-12 p-8 pb-[200px]">
      ...
      <div class="flex flex-col">
        ...
        <p class="mt-2 max-w-[750px] text-zinc-800">
          When enabled, the selected third-party voice will be the primary voice
          used by the app. The internal voice will still be used if the
          third-party voice fails. Third-party voices require a good internet
      ...
      <div class="flex flex-col gap-4">
        ...
        >
          <Show when={enableThirdPartyVoiceProviders()}>
            <Show
              when={!voices.loading}
              fallback={<div>Loading voices...</div>}
            >
