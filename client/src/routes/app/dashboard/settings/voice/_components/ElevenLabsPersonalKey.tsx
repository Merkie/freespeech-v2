...
import { user, setUser } from '@/lib/state';
...
const ElevenLabsPersonalKey: Component<ElevenLabsPersonalKeyProps> = (
  props
) => {
  const [usePersonalKey, setUsePersonalKey] = createSignal(
    props.usePersonalElevenLabsKey
  );
    ...
    <>
      <div class="flex flex-col">
        ...
        <p class="mt-2 max-w-[750px] text-zinc-800">
          Using a personal API key helps reduce our costs and it allows you to
          create custom AI voices based on short audio clips. Please visit{' '}
          <a
