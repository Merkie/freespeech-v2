...
const ElevenLabsVoiceSelector: Component<ElevenLabsVoiceSelectorProps> = (
  props
) => {
        ...
        <For each={props.voices}>
          {(voice, index) => (
            <div
              ...
              id={
                elevenLabsVoiceId() === voice.voice_id ? 'el-voice-active' : ''
              }
            >
              <button
              ...
              <div class="flex flex-1 flex-wrap items-center gap-1">
                <p class="mr-2 text-lg font-medium whitespace-nowrap">
                  {voice.name}
                </p>
